	  ...
	  <div class="panel">
		...
		<div class="row">
		  <div class="small-3 right columns">
			<i><h4><small>Registriere dich <a href="registration.class.php">hier</a>!</small></h3></i><br/>
			{if {$session} neq 'false'}
			  <i><h4><small><a href="logout.class.php">Logout</a>!</small></h3></i>
			{/if}
		  </div>
		</div>
	  </div>
	...
	<section class="top-bar-section">
	  <ul class="left">
		<li><a href="../index.php">Startseite</a></li>
		 {if {$session} neq 'false'}
		<li><a href="neuesRezept.class.php">Neues Rezept</a></li>
	  </ul>
