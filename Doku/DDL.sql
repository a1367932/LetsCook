...
-- Inserts:
INSERT INTO benutzer VALUES('Max', 'max@hotmail.com', 'Max', 'Maximilian', 'Mustermann', '1992-06-09', 'JÃ¤gerstrasse', '123', 1130, 'Wien', 'Austria', 'm', 'Max.jpg');

INSERT INTO kategorie VALUES ('FrÃ¼hstÃ¼ck', 'fruestueck.jpg', 'Lecker lecker Fruestueck');
...
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'KÃ¤sekuchen', SYSDATE(), 'Lecker Lecker KÃ¤se', 'KÃ¤sekuchen.jpg', 'Schoko, Mehl, Zucker', 1, 'Dessert');
...
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'Gerollte Mini-NusshÃ¶rnchen', SYSDATE(), 'Lecker Lecker HÃ¶rnchen', 'Gerollte Mini-NusshÃ¶rnchen.jpg', 'Schoko, Mehl, Zucker', 1, 'Dessert');
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'SchÃ¼ttelkuchen', SYSDATE(), 'Lecker Lecker SchÃ¼ttelkÃ¼chen', 'SchÃ¼ttelkuchen.jpg', 'Schoko, Mehl, Zucker', 1, 'Dessert');
...
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'Biskuitrolle mit ErdbeerfÃ¼llung', SYSDATE(), 'Lecker Lecker Erdbeere', 'Biskuitrolle mit ErdbeerfÃ¼llung.jpg', 'Schoko, Mehl, Zucker', 1, 'Dessert');
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'Japanische MelonenbrÃ¶tchen', SYSDATE(), 'Lecker Lecker Melone', 'Japanische MelonenbrÃ¶tchen.jpg', 'Schoko, Mehl, Zucker', 1, 'Dessert');
...
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'FrÃ¼hstÃ¼cksmuffins ', SYSDATE(), 'Lecker Lecker FrÃ¼hstÃ¼cks-Muffin', 'FrÃ¼hstÃ¼cksmuffins.jpg', 'Schoko, Mehl, Zucker', 1, 'FrÃ¼hstÃ¼ck');
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'KÃ¼rbiscremesuppe ', SYSDATE(), 'Lecker Lecker KÃ¼rbisse', 'KÃ¼rbiscremesuppe.jpg', 'Schoko, Mehl, Zucker', 1, 'Vorspeise');
...
INSERT INTO beitrag(bname, titel, bdatum, btext, bild, zutaten, portion, kname) VALUES ('Max', 'ErdÃ¤pfelsalat ', SYSDATE(), 'Lecker Lecker erdige Ã„pfel', 'ErdÃ¤pfelsalat.jpg', 'Schoko, Mehl, Zucker', 1, 'Beilage');
